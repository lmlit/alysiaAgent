...
| alysia-architecture | 总体架构（monorepo / 双模式） | active | docs/superpowers/specs/2026-07-20-alysia-architecture-design.md | 2026-08-10 输入合并+打断（即时生成修订 + 打断竞态修复）+ 采样参数统一配置 |
